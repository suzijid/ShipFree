                ...
                <div className={`max-w-[75%] ${isOwn ? 'items-end' : 'items-start'}`}>
                  ...
                  <div
                    className={`rounded-2xl px-4 py-2.5 text-sm ${
                      isOwn
                        ? 'bg-[#c9a96e]/20 text-white/90 rounded-br-md'
      ...
      <div className='border-t border-white/[0.08] p-4'>
        <div className='flex items-end gap-3'>
          <textarea
            ...
            rows={1}
            className='flex-1 resize-none rounded-xl border border-white/[0.08] bg-white/5 px-4 py-2.5 text-sm text-white/90 placeholder:text-white/25 focus:outline-none focus:ring-2 focus:ring-[#c9a96e]/30 focus:border-[#c9a96e]/40 transition-all'
          />
          <GlassButton
            variant='gold'
            onClick={handleSend}
